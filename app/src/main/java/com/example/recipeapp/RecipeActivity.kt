...
class RecipeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.step.setOnClickListener {
            ...
            binding.ing.setBackgroundResource(R.drawable.category_card_bc)
        ...
        binding.ing.setOnClickListener {
            ...
            binding.step.setBackgroundResource(R.drawable.category_card_bc)
        ...
        binding.like.setOnClickListener {
            var lik = 0
            if (lik==0){
                binding.like.setBackgroundResource(R.drawable.ic_favorite_red_24dp)
                lik++
            }else{
                binding.like.setBackgroundResource(R.drawable.ic_favorite_shadow_24dp)
                lik--
            }
        }
        ...
        binding.fullScreen.setOnClickListener{
            if (imgCrop){
                ...
                binding.shado.visibility= View.GONE
                imgCrop=!imgCrop
            }else{
